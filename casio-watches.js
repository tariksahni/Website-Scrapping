...
var checkIfProductPage = async.queue(function(obj, callback) {
  co(function*() {
    ...
    yield workbook.xlsx.writeFile('Casio_Watches.xlsx').then(function() {
  ...
  co(function*() {
    ...
    try {
      for (let i = 1; i < 57; i++) {//57
        let pst = '{%22PgControlId%22:2397938,%22IsConfigured%22:true,%22ConfigurationType%22:%22%22,%22CombiIds%22:%22%22,%22PageNo%22:' + i.toString() + ',%22DivClientId%22:%222397938_658114%22,%22SortingValues%22:%22CS%22,%22ShowViewType%22:%22H%22,%22PropertyBag%22:null,%22IsRefineExsists%22:false,%22CID%22:%22658114%22,%22CT%22:3,%22TabId%22:%220%22,%22LocationIds%22:%220%22,%22CurrencyCode%22:%22INR%22,%22ContentType%22:%22B%22}&_=1465380350892';
