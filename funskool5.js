...
const BaseUrl = "http://funskoolindia.com/products/search?brandId=41&filter=true&page=";
...
var fetchProductInfo = async.queue(function(url1, callback) {
  co(function*(){
    ...
    yield workbook.xlsx.writeFile("funskool_brand(warner).xlsx").then(function() {
