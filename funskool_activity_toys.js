...
const BaseUrl = "http://funskoolindia.com/products/search?brandId=37&filter=true&page=";
...
var fetchProductInfo = async.queue(function(url1, callback) {
  co(function*(){
    ...
    yield workbook.xlsx.writeFile("funskool_brand(nerf_zombie).xlsx").then(function() {
